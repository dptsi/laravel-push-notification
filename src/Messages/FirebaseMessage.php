...
namespace Dptsi\PushNotification\Messages;
...
class FirebaseMessage
{
    ...
    {
        if ($this->fromArray) {
            return PushNotification::fromArray($this->fromArray)->sendNotification($deviceTokens);
        }

        return PushNotification::withTitle($this->title)
            ->withBody($this->body)
    ...
    {
        if ($this->fromArray) {
            return PushNotification::fromArray($this->fromArray)->sendMessage($deviceTokens);
        }
