...
namespace Dptsi\PushNotification\Services;

use Illuminate\Http\Client\Response;
use Illuminate\Support\Facades\Http;
use Dptsi\PushNotification\Exceptions\UnsupportedTokenFormat;
...
class PushNotification
{
    ...
    private function callApi($fields): Response
    {
        $response = Http::withHeaders([
            'Authorization' => 'key=' . config('pushnotification.authentication_key')
